...
class EnviaVoucherImagenSentryLogger {

    static EnviaVoucherImagenRequest logBreadcrumbRequest(EnviaVoucherImagenRequest request, String url, SentryClient sentry) {
        sentry.getContext().recordBreadcrumb(new BreadcrumbBuilder()
                .setMessage("EnviaVoucherImagen request")
                .withData("url", url)
    ...
    static EnviaVoucherImagenResponse logBreadcrumbResponse(EnviaVoucherImagenResponse response, String url, SentryClient sentry) {
        sentry.getContext().recordBreadcrumb(new BreadcrumbBuilder()
                .setMessage("EnviaVoucherImagen response")
                .withData("url", url)
                .withData("codigoRespuesta", Convert.toString(response.codigoRespuesta))
                .withData("procReturnMsg", StringUtils.mask(response.procReturnMsg))
