...
public class OpPostAutorizacionSentryLogger {

    static OpPostAutorizacionRequest logBreadcrumbRequest(OpPostAutorizacionRequest request, String url, SentryClient sentry) {
        sentry.getContext().recordBreadcrumb(new BreadcrumbBuilder()
                .setMessage("OpPostAutorizacion request")
                .withData("url", url)
    ...
    static OpPostAutorizacionResponse logBreadcrumbResponse(OpPostAutorizacionResponse response, String url, SentryClient sentry) {
        sentry.getContext().recordBreadcrumb(new BreadcrumbBuilder()
                .setMessage("OpPostAutorizacion response")
                .withData("url", url)
