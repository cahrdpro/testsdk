...
public class EcommerceDevolucionSentryLogger {

    static EcommerceDevolucionRequest logBreadcrumbRequest(EcommerceDevolucionRequest request, String url, SentryClient sentry) {
        sentry.getContext().recordBreadcrumb(new BreadcrumbBuilder()
                .setMessage("EcommerceDevolucion request")
                .withData("url", url)
    ...
    static EcommerceDevolucionResponse logBreadcrumbResponse(EcommerceDevolucionResponse response, String url, SentryClient sentry) {
        sentry.getContext().recordBreadcrumb(new BreadcrumbBuilder()
                .setMessage("EcommerceDevolucion response")
                .withData("url", url)
