...
public class OpPreCancelacionSentryLogger {

    static OpPreCancelacionRequest logBreadcrumbRequest(OpPreCancelacionRequest request, String url, SentryClient sentry) {
        sentry.getContext().recordBreadcrumb(new BreadcrumbBuilder()
                .setMessage("OpPreCancelacion request")
                .withData("url", url)
    ...
    static OpPreCancelacionResponse logBreadcrumbResponse(OpPreCancelacionResponse response, String url, SentryClient sentry) {
        sentry.getContext().recordBreadcrumb(new BreadcrumbBuilder()
                .setMessage("OpPreCancelacion response")
                .withData("url", url)
