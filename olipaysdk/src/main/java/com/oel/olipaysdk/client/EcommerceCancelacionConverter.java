...
public class EcommerceCancelacionConverter {

    static SoapObject requestPojoToSoapObject(EcommerceCancelacionRequest request) {
        SoapObject soapObject = new SoapObject(NAMESPACE, "ecommerceCancelacion");
    ...
    static EcommerceCancelacionResponse soapObjectToResponsePojo(SoapObject soapObject) {
        EcommerceCancelacionResponse response = new EcommerceCancelacionResponse();
