...
public class OpPreAutorizacionSentryLogger {

    static OpPreAutorizacionRequest logBreadcrumbRequest(OpPreAutorizacionRequest request, String url, SentryClient sentry) {
        sentry.getContext().recordBreadcrumb(new BreadcrumbBuilder()
                .setMessage("OpPreAutorizacion request")
                .withData("url", url)
    ...
    static OpPreAutorizacionResponse logBreadcrumbResponse(OpPreAutorizacionResponse response, String url, SentryClient sentry) {
        sentry.getContext().recordBreadcrumb(new BreadcrumbBuilder()
                .setMessage("OpPreAutorizacion response")
                .withData("url", url)
